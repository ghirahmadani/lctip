        ...
        <div className="justify-items-center">
            <div className="grid container w-full h-72 p-8 gap-4 rounded-xl border border-gray-200 border-b-8 border-b-[#BE949E] hover:shadow-md content-between justify-items-center transition ease-in-out delay-100 hover:border-b-[#79245B]">
                <div className="grid content-start justify-items-center w-full gap-4">
                    ...
                    <h1 className="text-xl text-center fredoka font-semibold text-stone-900">{props.title}</h1>
                    <div className="grid w-full">
                        <p className="grid text-2xl font-bold content-center fredoka bg-white border-2 border-gray-100 w-full h-12 p-3 rounded-full text-stone-900 transition ease-in-out delay-100 hover:scale-105 hover:shadow-md duration-300">{props.money}</p>
                    </div>
